...
import SubProcessPositionAdjustmentBehavior from './SubProcessPositionAdjustmentBehavior';
...
export default {
  __init__: [
    ...
    'subProcessPositionAdjustmentBehavior',
  ...
  subProcessPositionAdjustmentBehavior: [ 'type', SubProcessPositionAdjustmentBehavior ],
